<script lang="ts">
	...
	async function logSuggestion(suggestion: ListenBrainzSuggestion) {
		...
		try {
			await apiPost(`/listenbrainz/suggestions/${suggestion.id}/log`, { rating: suggestionRating * 10 });
